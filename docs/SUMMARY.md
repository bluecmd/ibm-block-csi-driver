...
* [Release notes](book_files/csi_block_storage_kc_rn.md)
    * [What's new in 1.13.0](content/release_notes/whats_new.md)
...
* [Configuring](content/configuration/configuring.md)
    ...
    * [Configuring for IBM Storage Virtualize® partitions](content/configuration/configuring_svc_partitions.md)
